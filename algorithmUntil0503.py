...
def readInJSON():
    ...
    filepath = \
        'C:\\Users\\Disha\\Desktop\\SafeRouteRecommender\\crimes.json'
...
def main():
    ...
    theRoute = createRoute(sp, ep, aclocations) #this function will take in the startpoint and endpoint, convert them to lat/lon, call the google maps directions method,
    print theRoute                                 # which will return an encoded overview_polyline string of directions, the decode function will decode it and return a list
