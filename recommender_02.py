...
def readInJSON():
    ...
    '''
    extraloc = []
    extraloc.append(40.11636)
    extraloc.append(-88.23043)
    aclocations.append(extraloc)
    '''
    retCrimes = []
    retCrimes.append(aclocations)
    retCrimes.append(vtlocations)
...
def createRoutewithwaypoints(client, dangerpoint, waypoints, ac, vt, sp, ep):
    ...
    #print(newpath)
    return createRoute(client, sp, ep, newpath, wp , ac, vt)

def createRoute(client, startpoint, endpoint, mainPath, waypoints, ac, vt):
    i, succ = checkPathSafe(mainPath, ac, vt);
    if(succ):
        ...
        return createRoutewithwaypoints(client,mainPath[i], waypoints, ac, vt, startpoint, endpoint)
